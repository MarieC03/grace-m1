...
class eos_base_t {
 ...
 public:
    ...
    eos_base_t( double _eos_rhomax, double _eos_rhomin
              ...
              , double _eos_ymumax, double _eos_ymumin
              , double _baryon_mass, double _c2p_eps_min
              , double _c2p_eps_max, double _c2p_h_min
              , double _c2p_h_max, double _c2p_temp_atm, double _c2p_ye_atm, double _c2p_ymu_atm, bool _atm_is_beta_eq)
     ...
     , eos_ymumax(_eos_ymumax), eos_ymumin(_eos_ymumin)
     , baryon_mass(_baryon_mass), c2p_eps_min(_c2p_eps_min), c2p_eps_max(_c2p_eps_max)
     , c2p_h_min(_c2p_h_min), c2p_h_max(_c2p_h_max), c2p_temp_atm(_c2p_temp_atm), c2p_ye_atm(_c2p_ye_atm), c2p_ymu_atm(_c2p_ymu_atm)
     , atm_is_beta_eq(_atm_is_beta_eq)
    {}
    /**
     * @brief Get pressure given eps rho, ye and ymu.
     *
     * @param eps Specific internal energy.
     * @param rho Rest-mass density.
     * @param ye  Electron fraction.
     * @param ymu Muon fraction.
     * @param err Error code.
     * @return double The pressure.
     */
    double GRACE_HOST_DEVICE
    press__eps_rho_ye_ymu(double& eps, double& rho, double& ye, double& ymu, error_type& err) const
    {
        return static_cast<eos_impl_t const*>(this)->press__eps_rho_ye_ymu_impl(eps,rho,ye,ymu,err) ;
    }
    /**
     * @brief Get pressure and temperature given eps, rho, ye and ymu.
     *
     ...
     */
    double GRACE_HOST_DEVICE
    press_temp__eps_rho_ye_ymu(double& temp, double& eps, double& rho, double& ye, double& ymu, error_type& err) const
    {
        return static_cast<eos_impl_t const*>(this)->press_temp__eps_rho_ye_ymu_impl(temp,eps,rho,ye,ymu,err) ;
    }
    /**
     * @brief Get pressure given temperature, rho, ye and ymu.
     *
     * @param temp Temperature.
     * @param rho Rest-mass density.
     * @param ye  Electron fraction.
     ...
     */
    double GRACE_HOST_DEVICE
    press__temp_rho_ye_ymu(double& temp, double& rho, double& ye, double& ymu, error_type& err) const
    {
        return static_cast<eos_impl_t const*>(this)->press__temp_rho_ye_ymu_impl(temp,rho,ye,ymu,err) ;
    }
    /**
     * @brief Get eps given temperature, rho, ye and ymu.
     *
     * @param temp Temperature.
     * @param rho Rest-mass density.
     * @param ye  Electron fraction.
     ...
     */
    double GRACE_HOST_DEVICE
    eps__temp_rho_ye_ymu(double& temp, double& rho, double& ye, double& ymu, error_type& err) const
    {
        return static_cast<eos_impl_t const*>(this)->eps__temp_rho_ye_ymu_impl(temp,rho,ye,ymu,err) ;
    }
    /**
     * @brief Range of epsilon given rho, ye and ymu.
     *
    ...
    eps_range__rho_ye_ymu(double& eps_min, double& eps_max, double &rho, double &ye, double &ymu, error_type &err) const
    {
        static_cast<eos_impl_t const*>(this)->eps_range__rho_ye_ymu_impl(eps_min,eps_max,rho,ye,ymu,err) ;
    }
    /**
     * @brief Range of entropy given rho, ye and ymu.
     *
     * @param s_min Minimum entropy.
     * @param s_max Maximum entropy.
     * @param rho   Rest-mass density.
     * @param ye    Electron fraction.
     * @param ymu   Muon fraction.
     * @param err   Error code.
     */
    void GRACE_HOST_DEVICE
    entropy_range__rho_ye_ymu(double& s_min, double& s_max, double &rho, double &ye, double &ymu, error_type &err) const
    {
        static_cast<eos_impl_t const*>(this)->entropy_range__rho_ye_ymu_impl(s_min,s_max,rho,ye,ymu,err) ;
    }
    /**
     ...
     */
    double GRACE_HOST_DEVICE
    press_h_csnd2__eps_rho_ye_ymu( double &h, double &csnd2, double &eps
                             , double &rho, double &ye, double &ymu
                             , error_type &err) const
    {
        return static_cast<eos_impl_t const*>(this)->press_h_csnd2__eps_rho_ye_ymu_impl(h,csnd2,eps,rho,ye,ymu,err) ;
    }
    /**
     * @brief Pressure, specific enthalpy and
     ...
     */
    double GRACE_HOST_DEVICE
    press_h_csnd2__temp_rho_ye_ymu( double &h, double &csnd2, double &temp
                              , double &rho, double &ye, double &ymu
                              , error_type &err) const
    {
        return static_cast<eos_impl_t const*>(this)->press_h_csnd2__temp_rho_ye_ymu_impl(h,csnd2,temp,rho,ye,ymu,err) ;
    }
    /**
     ...
     */
    double GRACE_HOST_DEVICE
    press_eps_csnd2__temp_rho_ye_ymu( double &eps, double &csnd2, double &temp
                                , double &rho, double &ye, double &ymu
                                , error_type& err) const
    {
        return static_cast<eos_impl_t const*>(this)->press_eps_csnd2__temp_rho_ye_ymu_impl(eps,csnd2,temp,rho,ye,ymu,err) ;
    }
    /**
     ...
     */
    double GRACE_HOST_DEVICE
    press_h_csnd2_temp_entropy__eps_rho_ye_ymu( double& h, double& csnd2, double& temp
                                          , double& entropy, double& eps
                                          , double& rho, double& ye, double& ymu
                                          , error_type& err ) const
    {
        return static_cast<eos_impl_t const*>(this)->press_h_csnd2_temp_entropy__eps_rho_ye_ymu_impl(h,csnd2,temp,entropy,eps,rho,ye,ymu,err);
    }
    /**
     * @brief Epsilon, square sound speed and entropy
     *        given temperature, rho, ye and ymu.
     *
     * @param csnd2   Square sound speed.
     * @param entropy Entropy per baryon.
     * @param temp    Temperature.
     ...
     */
    double GRACE_HOST_DEVICE
    eps_csnd2_entropy__temp_rho_ye_ymu( double& csnd2, double& entropy, double& temp
                                  , double& rho, double& ye, double& ymu
                                  , error_type& err ) const
    {
        return static_cast<eos_impl_t const*>(this)->eps_csnd2_entropy__temp_rho_ye_ymu_impl(csnd2,entropy,temp,rho,ye,ymu,err);
    }
    /**
     ...
     */
    double GRACE_HOST_DEVICE
    press_eps_csnd2_entropy__temp_rho_ye_ymu( double& eps, double& csnd2, double& entropy, double& temp
                                  , double& rho, double& ye, double& ymu
                                  , error_type& err ) const
    {
        return static_cast<eos_impl_t const*>(this)->press_eps_csnd2_entropy__temp_rho_ye_ymu_impl(eps,csnd2,entropy,temp,rho,ye,ymu,err);
    }
    /**
     * @brief Pressure, specific enthalpy, square sound speed,
     *        temperature and specific internal energy given
     *        entropy, rho, ye and ymu.
     *
     * @param h       Specific enthalpy.
     * @param csnd2   Square sound speed.
     * @param temp    Temperature.
     ...
     */
    double GRACE_HOST_DEVICE
    press_h_csnd2_temp_eps__entropy_rho_ye_ymu( double& h, double& csnd2, double& temp
                                          , double& eps, double& entropy, double& rho
                                          , double& ye, double& ymu, error_type& err) const
    {
        return static_cast<eos_impl_t const*>(this)->press_h_csnd2_temp_eps__entropy_rho_ye_ymu_impl(h,csnd2,temp,eps,entropy,rho,ye,ymu,err) ;
    }
    /**
     * @brief Specific internal energy, specific enthalpy,
     *        square sound speed, temperature and entropy
     *        given pressure, rho, ye and ymu.
     *
     * @param h       Specific enthalpy.
     * @param csnd2   Square sound speed.
     * @param temp    Temperature.
     ...
     */
    double GRACE_HOST_DEVICE
    eps_h_csnd2_temp_entropy__press_rho_ye_ymu( double& h, double& csnd2, double& temp
                                          , double& entropy, double& press, double& rho
                                          , double& ye, double& ymu, error_type& err) const
    {
        return static_cast<eos_impl_t const*>(this)->eps_h_csnd2_temp_entropy__press_rho_ye_ymu_impl(h,csnd2,temp,entropy,press,rho,ye,ymu,err) ;
    }
    ...
    /**
     * @brief Muon fraction on cold table given rest mass dens
     *
     * @param rho Rest-mass density.
     * @param err Error code.
     * @return double The muon fraction
     */
    double GRACE_HOST_DEVICE
    ymu_cold__rho(double& rho, error_type& err) const
    {
        return static_cast<eos_impl_t const*>(this)->ymu_cold__rho_impl(rho,err) ;
    }
    /**
     * @brief Muon fraction on cold table given pressure
     *
     * @param press Cold pressure.
     * @param err   Error code.
     * @return double The muon fraction
     */
    double GRACE_HOST_DEVICE
    ymu_cold__press(double& press, error_type& err) const
    {
        return static_cast<eos_impl_t const*>(this)->ymu_cold__press_impl(press,err) ;
    }
    /**
     ...
     */
    double GRACE_ALWAYS_INLINE GRACE_HOST_DEVICE
    get_c2p_ymu_max() const { return eos_ymumax ; }
    /**
     * @brief Get maximum allowed epsilon, might differ from table bound.
     */
    double GRACE_ALWAYS_INLINE GRACE_HOST_DEVICE
    get_c2p_ymu_min() const { return eos_ymumin ; }
    /**
     * @brief Get maximum allowed epsilon, might differ from table bound.
     */
    double GRACE_ALWAYS_INLINE GRACE_HOST_DEVICE
    ...
    /**
     * @brief Get the atmosphere muon fraction.
     *
     */
    double GRACE_ALWAYS_INLINE GRACE_HOST_DEVICE
    ymu_atmosphere() const { return c2p_ymu_atm ; }
    /**
 ...
 protected:
    ...
    //! Maximum and minimum muon fractions.
    double eos_ymumax, eos_ymumin ;
    //! Baryon mass.
    double baryon_mass ;
